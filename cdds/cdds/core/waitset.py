...
from cdds.internal.dds_types import dds_entity_t, dds_attach_t, dds_return_t, dds_duration_t
...
class WaitSet(Entity):
    ...
    def _waitset_wait(self, waitset: dds_entity_t, xs: POINTER(dds_attach_t),
                      nxs: c_size_t, reltimeout: dds_duration_t) -> dds_return_t:
        pass

    @c_call("dds_waitset_wait_until")
    def _waitset_wait_until(self, waitset: dds_entity_t, xs: POINTER(dds_attach_t),
                            nxs: c_size_t, abstimeout: dds_duration_t) -> dds_return_t:
        pass
