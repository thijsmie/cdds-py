...
from cdds.internal import c_call, c_callable, dds_entity_t, dds_return_t, dds_qos_p_t, dds_listener_p_t, dds_topic_descriptor_p_t
...
class Topic(Entity):
    ...
    def __init__(self, domain_participant: 'cdds.domain.DomainParticipant', data_type, topic_name: str, qos=None, listener=None):
