...
class Subscriber(Entity):
    def __init__(self, domain_participant: 'cdds.domain.DomainParticipant', qos=None, listener=None):
        super().__init__(
    ...
    def _create_subscriber(self, domain_participant: dds_entity_t, qos: dds_qos_p_t,
