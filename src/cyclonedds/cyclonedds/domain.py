...
class Domain(Entity):
    ...
    def get_participants(self) -> List[Entity]:
        ...
        ret = self._lookup_participant(self._id, ct.cast(ct.byref(participants_list), ct.POINTER(dds_c_t.entity)), num_participants)
        if ret >= 0:
    ...
    def _lookup_participant(self, id: dds_c_t.domainid, participants: ct.POINTER(dds_c_t.entity), size: ct.c_size_t) -> dds_c_t.entity:
        pass
...
class DomainParticipant(Entity):
    ...
    def _create_participant(self, domain_id: dds_c_t.domainid, qos: dds_c_t.qos_p, listener: dds_c_t.listener_p) -> dds_c_t.entity:
        pass
